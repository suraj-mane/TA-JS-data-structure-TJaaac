...
for(let i = 0; i < movies.length-0; i++){
  let years = movies[i].year;
  if(years > 2017){
    console.log(`${years} is greater than 2017`);
  } else {
    console.log(`${years} is not greater`);
  }
}
// 23. Log the title of all three movies one by one.
for(let j = 0; j < movies.length-0; j++){
...
for(let i = 0; i < movies.length; i++){
  let genre = movies[i].genres.length;
  if(genre > 1){
    console.log(movies);
  }
}
...
for(let i = 0; i < movies.length; i++){
  let actor = movies[i].actors.length;
  if(actor > 1){
    console.log(movies);
  }
}
...
for(let i = 0; i < movies.length; i++){
  let years = movies[i].year.length;
  if(years == 2018){
